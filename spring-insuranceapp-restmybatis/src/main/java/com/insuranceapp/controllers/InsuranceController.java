...
public class InsuranceController {
	...
	@GetMapping("/insurances/type-premiun")
	ResponseEntity<List<Insurance>>getByTypeAndLesserPremiun(
			@RequestParam("type")String type,@RequestParam("premiun")double premiun){
		List<Insurance>insurances = insuranceService.getByTypeAndLesserPremiun(type, premiun);
		HttpHeaders headers = new HttpHeaders();
